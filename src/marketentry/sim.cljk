...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (SYC, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up director-conviction-disqualifying) ==")
    ...
    (println "== filing/submit eng-4 (director-conviction-disqualifying -> HARD hold) ==")
